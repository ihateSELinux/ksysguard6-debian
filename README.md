...
This is forked from zvova7890's own fork of **the KSysGuard app** (no longer shipped
with KDE 6). https://github.com/zvova7890/ksysguard6
...
# Installation
On Debian KDE it should be as simple as downloading the latest .deb from [releases](https://github.com/ihateSELinux/ksysguard6-debian/releases/) and double-clicking it to install through Discover.
